...
class QuestionJson {
    fun getQuestion():ArrayList<TextQuestion> {
        ...
        for (i in 0 until result.length()) {
            ...
            val correct_answer = result.getString("correct_answer")
            val incorrect_answers = ArrayList<String>()
            val incorrect_answers_json = result.getJSONArray("incorrect_answers")
